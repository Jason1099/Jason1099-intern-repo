...
To see if it can detect and "see" the focus bear app, I used a test script to print out the list of control identifiers of the app, which can be seen in this link (copy here) <br/>
